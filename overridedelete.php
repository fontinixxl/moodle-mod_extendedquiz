...
$url = new moodle_url('/mod/extendedquiz/overridedelete.php', array('id'=>$override->id));
$confirmurl = new moodle_url($url, array('id'=>$override->id, 'confirm'=>1));
$cancelurl = new moodle_url('/mod/extendedquiz/overrides.php', array('cmid'=>$cm->id));
...
if ($confirm) {
    ...
    add_to_log($cm->course, 'extendedquiz', 'delete override',
