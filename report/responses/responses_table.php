 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_responses_table extends extendedquiz_attempts_report_table {
     ...
     * @param extendedquiz_responses_options $options
     * @param array $groupstudents
     * @param array $students
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($quiz, $context, $qmsubselect, extendedquiz_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-extendedquiz-report-responses-report', $quiz, $context,
