 ...
 */
function extendedquiz_statistics_questiontext_preview_pluginfile($context, $questionid, $args, $forcedownload, array $options=array()) {
    global $CFG;
    ...
    require_capability('extendedquiz/statistics:view', $context);
...
function quiz_statistics_cron() {
    ...
    $todelete = $DB->get_records_select_menu('extendedquiz_statistics',
