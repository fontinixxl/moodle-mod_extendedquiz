 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_extendedquiz_admin_review_setting extends admin_setting {
    /**#@+
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_extendedquiz_admin_setting_grademethod extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        ...
        $this->choices = extendedquiz_get_grading_options();
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_extendedquiz_admin_setting_browsersecurity extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        global $CFG;
        ...
        require_once($CFG->dirroot . '/mod/extendedquiz/locallib.php');
        $this->choices = extendedquiz_access_manager::get_browser_security_choices();
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_extendedquiz_admin_setting_overduehandling extends admin_setting_configselect_with_advanced {
    public function load_choices() {
        global $CFG;
        ...
        require_once($CFG->dirroot . '/mod/extendedquiz/locallib.php');
        $this->choices = extendedquiz_get_overdue_handling_options();
