...
$PAGE->set_url('/mod/extendedquiz/summary.php', array('attempt' => $attemptid));
...
// Log this page view.
add_to_log($attemptobj->get_courseid(), 'extendedquiz', 'view summary',
...
$navbc = $attemptobj->get_navigation_panel($output, 'extendedquiz_attempt_nav_panel', -1);
