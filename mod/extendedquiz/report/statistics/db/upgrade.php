 ...
 */
function xmldb_extendedquiz_statistics_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2012061800) {
        ...
        $table = new xmldb_table('extendedquiz_q_resp_stats');
        ...
        upgrade_plugin_savepoint(true, 2012061800, 'extendedquiz', 'statistics');
    }
    ...
    if ($oldversion < 2012061801) {
        ...
        // Statistics savepoint reached.
        upgrade_plugin_savepoint(true, 2012061801, 'extendedquiz', 'statistics');
    }
