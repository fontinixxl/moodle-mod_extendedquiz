...
/**
 * Implementaton of the extendedquizaccess_ipaddress plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class extendedquizaccess_ipaddress extends extendedquiz_access_rule_base {
    ...
    public function prevent_access() {
        if (address_in_subnet(getremoteaddr(), $this->quiz->subnet)) {
            ...
            return get_string('subnetwrong', 'extendedquizaccess_ipaddress');
        }
    }
}
