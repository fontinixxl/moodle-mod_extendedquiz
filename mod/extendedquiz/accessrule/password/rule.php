...
/**
 * Implementaton of the extendedquizaccess_password plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class extendedquizaccess_password extends extendedquiz_access_rule_base {
    ...
    public function description() {
        return get_string('requirepasswordmessage', 'extendedquizaccess_password');
    }
    ...
    public function add_preflight_check_form_fields(mod_extendedquiz_preflight_check_form $quizform,
        ...
        $mform->addElement('static', 'passwordmessage', '',
                get_string('requirepasswordmessage', 'extendedquizaccess_password'));
        ...
        $mform->addElement('password', 'quizpassword',
                get_string('quizpassword', 'extendedquizaccess_password'));
    }
    ...
    public function validate_preflight_check($data, $files, $errors, $attemptid) {
        ...
        $errors['quizpassword'] = get_string('passworderror', 'extendedquizaccess_password');
        return $errors;
    }
