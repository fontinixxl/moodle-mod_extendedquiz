...
/**
 * Implementaton of the extendedquizaccess_securewindow plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class extendedquizaccess_securewindow extends extendedquiz_access_rule_base {
    ...
    public function setup_attempt_page($page) {
        ...
        $page->requires->js_init_call('M.mod_extendedquiz.secure_window.init',
                null, false, extendedquiz_get_js_module());
    }
    ...
    public static function get_browser_security_choices() {
        return array('securewindow' =>
                get_string('popupwithjavascriptsupport', 'extendedquizaccess_securewindow'));
    }
}
