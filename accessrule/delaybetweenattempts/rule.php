...
/**
 * Implementaton of the extendedquizaccess_delaybetweenattempts plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class extendedquizaccess_delaybetweenattempts extends extendedquiz_access_rule_base {
    ...
    public function prevent_new_attempt($numprevattempts, $lastattempt) {
        ...
        if ($this->timenow < $nextstarttime) {
            if ($this->quiz->timeclose == 0 || $nextstarttime <= $this->quiz->timeclose) {
                return get_string('youmustwait', 'extendedquizaccess_delaybetweenattempts',
                        userdate($nextstarttime));
            } else {
                return get_string('youcannotwait', 'extendedquizaccess_delaybetweenattempts');
            }
        }
        return false;
    }
