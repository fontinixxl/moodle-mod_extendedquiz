...
/**
 * Base class for rules that restrict the ability to attempt a extendedquiz.
 *
 * @package    mod
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class extendedquiz_access_rule_base {
    /** @var stdClass the quiz settings. */
    protected $quiz;
    /** @var extendedquiz the quiz object. */
    protected $quizobj;
     ...
     * @return extendedquiz_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_extendedquiz_preflight_check_form $quizform the form being built.
     * @param MoodleQuickForm $mform The wrapped MoodleQuickForm.
     * @param int|null $attemptid the id of the current attempt, if there is one,
     *      otherwise null.
     */
    public function add_preflight_check_form_fields(mod_extendedquiz_preflight_check_form $quizform,
    ...
    public static function validate_settings_form_fields(array $errors,
            array $data, $files, mod_extendedquiz_mod_form $quizform) {
