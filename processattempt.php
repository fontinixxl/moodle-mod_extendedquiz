...
if ($timeclose !== false && $timenow > $timeclose - QUIZ_MIN_TIME_TO_CONTINUE) {
    $timeup = true;
    $graceperiodmin = get_config('extendedquiz', 'graceperiodmin');
...
if ($attemptobj->is_finished()) {
    throw new moodle_extendedquiz_exception($attemptobj->get_quizobj(),
...
add_to_log($attemptobj->get_courseid(), 'extendedquiz', 'close attempt',
