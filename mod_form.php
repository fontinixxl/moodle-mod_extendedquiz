...
/**
 * The main extendedquiz configuration form
 *
...
/**
 * Settings form for the extendedquiz module.
 *
 * @copyright  2006 Jamie Pratt
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_extendedquiz_mod_form extends moodleform_mod {
	...
	global $COURSE, $CFG, $DB, $PAGE;
        $quizconfig = get_config('extendedquiz');
        $mform = $this->_form;
...
//-------------------------------------Extended quiz--------------------------------------------------
        ...
        //toDo: include this lines in module.js script (yui3)
        ...
        */
        ...
        // Button label
        if (!empty($this->_instance)) {
        	$buttonlabel = get_string('refreshvarsvalues', 'extendedquiz');
        } else {
        	$buttonlabel = get_string('assignvarsvalues', 'extendedquiz');
        }
        ...
        $mform->addElement('header', 'varsheader', get_string("varsvalues", "extendedquiz"));
        ...
        $mform->addElement('select', 'overduehandling', get_string('overduehandling', 'quiz'),
                extendedquiz_get_overdue_handling_options());
        ...
        $mform->addElement('select', 'grademethod', get_string('grademethod', 'quiz'),
                extendedquiz_get_grading_options());
        ...
        */
        ...
        //guided quiz: bloquejat, ja que volem cada pregunta en una pagina
        ...
        */
        ...
        // Navigation method.
         $mform->addElement('select', 'navmethod', get_string('navmethod', 'quiz'),
                extendedquiz_get_navigation_options());
        ...
        $this->add_review_options_group($mform, $quizconfig, 'during',
                mod_extendedquiz_display_options::DURING, true);
        $this->add_review_options_group($mform, $quizconfig, 'immediately',
                mod_extendedquiz_display_options::IMMEDIATELY_AFTER);
        ...
        // --------------------FALTA CANVIAR GETSTRING CAP A extendedquiz-----------------------------------------------------------
        ...
        $mform->addElement('select', 'browsersecurity', get_string('browsersecurity', 'quiz'),
                extendedquiz_access_manager::get_browser_security_choices());
        ...
        extendedquiz_access_manager::add_settings_form_fields($this, $mform);
    ...
    public function data_preprocessing(&$toform) {
        ...
        if (!empty($toform['instance'])) {
            $accesssettings = extendedquiz_access_manager::load_settings($toform['instance']);
