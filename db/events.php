...
$handlers = array(
    // Handle our own extendedquiz_attempt_submitted event, as a way to send confirmation
    // messages asynchronously.
    'extendedquiz_attempt_submitted' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedextendedquiz_attempt_submitted_handler',
        'schedule'        => 'cron',
    ),

    // Handle our own extendedquiz_attempt_overdue event, to email the student to let them
    // know they forgot to submit, and that they have another chance.
    'extendedquiz_attempt_overdue' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedextendedquiz_attempt_overdue_handler',
        'schedule'        => 'cron',
    ),
    ...
    'groups_member_added' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedquiz_groups_member_added_handler',
        'schedule'        => 'instant',
    ),
    'groups_member_removed' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedquiz_groups_member_removed_handler',
        'schedule'        => 'instant',
    ),
    'groups_members_removed' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedquiz_groups_members_removed_handler',
        'schedule'        => 'instant',
    ),
    'groups_group_deleted' => array (
        'handlerfile'     => '/mod/extendedquiz/locallib.php',
        'handlerfunction' => 'extendedquiz_groups_group_deleted_handler',
        'schedule'        => 'instant',
    ),
);
...
extendedquiz_attempt_submitted
    ->component   = 'mod_quiz';
